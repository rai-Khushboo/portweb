      ...
      <div className="flex items-center justify-between container mx-auto text-lg text-white">
        ...
        <ul className="hidden md:flex space-x-8 text-lg">
          <li className="flex items-center group transition hover:bg-primary/30 hover:text-primary rounded px-2 focus-visible:ring-2 focus-visible:ring-primary">
            ...
            <Link to="/" className="text-white transition-colors duration-300 group-hover:text-primary hover:text-primary hover:underline hover:decoration-white">Home</Link>
          </li>
          <li className="flex items-center group transition hover:bg-primary/30 hover:text-primary rounded px-2 focus-visible:ring-2 focus-visible:ring-primary">
            <FaInfoCircle className="text-white mr-2 transition-colors duration-300 group-hover:text-primary" />
            <Link to="/about" className="text-white transition-colors duration-300 group-hover:text-primary hover:text-primary hover:underline hover:decoration-white">About</Link>
          </li>
          <li className="flex items-center group transition hover:bg-primary/30 hover:text-primary rounded px-2 focus-visible:ring-2 focus-visible:ring-primary">
            <FaProjectDiagram className="text-white mr-2 transition-colors duration-300 group-hover:text-primary" />
            <Link to="/projects" className="text-white transition-colors duration-300 group-hover:text-primary hover:text-primary hover:underline hover:decoration-white">Projects</Link>
          </li>
          <li className="flex items-center group transition hover:bg-primary/30 hover:text-primary rounded px-2 focus-visible:ring-2 focus-visible:ring-primary">
            <FaCog className="text-white mr-2 transition-colors duration-300 group-hover:text-primary" />
            <Link to="/techstacks" className="text-white transition-colors duration-300 group-hover:text-primary hover:text-primary hover:underline hover:decoration-white">TechStacks</Link>
          </li>
          <li className="flex items-center group transition hover:bg-primary/30 hover:text-primary rounded px-2 focus-visible:ring-2 focus-visible:ring-primary">
            <FaCertificate className="text-white mr-2 transition-colors duration-300 group-hover:text-primary" />
            <Link to="/certifications" className="text-white transition-colors duration-300 group-hover:text-primary hover:text-primary hover:underline hover:decoration-white">Certifications</Link>
          </li>
          <li className="flex items-center group transition hover:bg-primary/30 hover:text-primary rounded px-2 focus-visible:ring-2 focus-visible:ring-primary">
            <FaEnvelope className="text-white mr-2 transition-colors duration-300 group-hover:text-primary" />
            <Link to="/contact" className="text-white transition-colors duration-300 group-hover:text-primary hover:text-primary hover:underline hover:decoration-white">Contact</Link>
          </li>
        </ul>
